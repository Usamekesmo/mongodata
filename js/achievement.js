// =============================================================
// ==      وحدة نظام الإنجازات - لا تحتاج لتعديل              ==
// =============================================================
...
// تم تعريف الإنجازات بشكل ثابت داخل الكود
...
export function checkAchievements(eventName, eventData = {}) {
    ...
    for (const achievement of relevantAchievements) {
        // التأكد من أن اللاعب لم يحصل على الإنجاز من قبل
        if (player.playerData.achievements && player.playerData.achievements.includes(achievement.id)) {
            continue;
        }
...
function isConditionMet(achievement, eventData) {
    ...
    const dataContext = {
        ...
        inventorySize: player.playerData.inventory ? player.playerData.inventory.length : 0,
        totalQuizzes: player.playerData.total_quizzes_completed || 0
    };
...
function grantAchievement(achievement) {
    ...
    if (!player.playerData.achievements) {
